...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/simonsi/public/home/assets/vendor/datepicker/tempusdominus-bootstrap-4.css" />
    <link rel="stylesheet" href="http://localhost/simonsi/public/home/assets/vendor/inputmask/css/inputmask.css" />
</head>
...
John Abraham</h5>
            ...
            <div class="container-fluid dashboard-content">
                <div class="row">
                    <div class="col-xl-10">
                        ...
                        <!-- inputmask -->
                        <!-- ============================================================== -->
                        <form class="needs-validation" method="post" action="index.php?simonsi=update_data&id=<?php echo $id ?>" >
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend be-addon">
                                                            <select class="btn btn-secondary" name="dosen" id="dosens">
                                                            <option name="dosen" class="dropdown-item"  value="<?php echo $dosen['id']; ?>"><?php echo $dosen['name']; ?></option>
                                                ...
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend be-addon">
                                                            <select class="btn btn-secondary" name="matkul" id="sel_user">
                                                            <div class="dropd" ></div>
                                                            <option  value='<?php echo $matkul['id'] ?>'><?php echo $matkul['name'] ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        <label for="validationCustom01">1. Dosen Melakukan Kontrak Pembelajaran Dengan Mahasiswa Pada Tatap Muka Minggu Pertama.</label><br/>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal1'] == 1) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal1" value="1"  class="custom-control-input"><span class="custom-control-label">Sangat Baik</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal1'] == 2) {
                                                                echo "checked";
                                                            } ?>  type="radio" name="soal1" value="2" class="custom-control-input"><span class="custom-control-label">Baik</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal1'] == 3) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal1" value="3" class="custom-control-input"><span class="custom-control-label">Cukup</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal1'] == 4) {
                                                                echo "checked";
                                                            } ?>  type="radio" name="soal1" value="4" class="custom-control-input"><span class="custom-control-label">Kurang</span>
                                                        </label>
                                                    </div>

                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        <label for="validationCustom01">2. Dosen Menguasai Materi Mata Kuliah Sesuai Kontrak Pembelajaran</label><br/>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal2'] == 1) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal2" value="1"  class="custom-control-input"><span class="custom-control-label">Sangan Baik</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal2'] == 2) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal2" value="2" class="custom-control-input"><span class="custom-control-label">Baik</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal2'] == 3) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal2" value="3" class="custom-control-input"><span class="custom-control-label">Cukup</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal2'] == 4) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal2" value="4" class="custom-control-input"><span class="custom-control-label">Kurang</span>
                                                        </label>
                                                    </div>

                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        <label for="validationCustom01">3. Materi Kuliah Telah Sesuai Dengan Perkembangan Ipteks Terbaru.</label><br/>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal3'] == 1) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal3" value="1"  class="custom-control-input"><span class="custom-control-label">Sangat Baik</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal3'] == 2) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal3" value="2" class="custom-control-input"><span class="custom-control-label">Baik</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal3'] == 3) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal3" value="3" class="custom-control-input"><span class="custom-control-label">Cukup</span>
                                                        </label>
                                                        <label class="custom-control custom-radio custom-control-inline">
                                                            <input <?php if ($penilaian['soal3'] == 4) {
                                                                echo "checked";
                                                            } ?> type="radio" name="soal3" value="4" class="custom-control-input"><span class="custom-control-label">Kurang</span>
                                                        </label>
                                                    </div><br/><br/>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                    <label for="validationCustom01">Saran</label><br/>
                                                        <textarea name="saran" required="" class="form-control"><?php echo $penilaian['saran'] ?></textarea>
                                                    </div><br/>
    ...
    <script src="http://localhost/simonsi/public/home/assets/vendor/inputmask/js/jquery.inputmask.bundle.js"></script>
    <script>
    $(document).ready(function(){

$("#dosens").change(function(){
    var matkulid = $(this).val();
    $.ajax({
        url: 'http://localhost/simonsi/index.php?simonsi=get_matkul',
        type: 'post',
