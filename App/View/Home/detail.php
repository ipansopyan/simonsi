...
John Abraham</h5>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col"><div id="prodi"> <?php echo $prodi['name']; ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $tahun['name']; ?></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Tanggal Penilaian</th>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                            <tr>
                                                <th rowspan="2">No</th>
                                                <th rowspan="2"  class="text-center" scope="col">Soal</th>
                                                <th colspan="4" class="text-center"  span="3" scope="col">First</th>
                                            </tr>
                                            <tr>
                                                <th>sangat baik</th>
                                                <th>baik</th>
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <th scope="row">Dosen Melakukan Kontrak Pembelajaran Dengan Mahasiswa Pada Tatap Muka Minggu Pertama.</th>
                                                <td id="soal1" class="text-center"><?php if ($penilaian['soal1'] == 1) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal1'] == 2) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal1'] == 3) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal1'] == 4) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <th scope="row">Dosen Menguasai Materi Mata Kuliah Sesuai Kontrak Pembelajaran</th>
                                                <td class="text-center"><?php if ($penilaian['soal2'] == 1) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal2'] == 2) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal2'] == 3) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal2'] == 4) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <th scope="row">Materi Kuliah Telah Sesuai Dengan Perkembangan Ipteks Terbaru.</th>
                                                <td class="text-center"><?php if ($penilaian['soal3'] == 1) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal3'] == 2) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal3'] == 3) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                                <td class="text-center"><?php if ($penilaian['soal3'] == 4) {
                                                    echo"<i class='fas fa-check-circle'>";
                                                } ?></i></td>
                                            </tr>
                                            <tr>
                                                <td>Saran</td>
                                                <td colspan="5" ><?php echo $penilaian['saran'] ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
    ...
    <script src="http://localhost/simonsi/public/home/assets/vendor/custom-js/jquery.multi-select.html"></script>
