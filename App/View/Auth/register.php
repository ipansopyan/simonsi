        ...
        <div class="container">
            <form method="POST" action="index.php?simonsi=registered" class="appointment-form" id="appointment-form">
                ...
                <div class="form-check">
                    ...
                    <label for="agree-term" class="label-agree-term"><span><span></span></span>Tos gaduh akun <a href="http://localhost/simonsi" class="term-service">login we di dieu</a></label>
                </div>
